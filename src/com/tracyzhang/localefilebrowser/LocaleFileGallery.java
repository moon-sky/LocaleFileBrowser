...
import com.tracyzhang.localefilebrowser.util.Utils;
 ...
 *
 */
public class LocaleFileGallery extends Activity implements OnItemClickListener {
...
//		Log.i(tag, "gridSize:"+gridSize);
	...
	protected void onResume() {
		...
		super.onResume();
		if(null == data){
			LFBApplication bxApp = (LFBApplication) getApplication();
	...
	class MyGVAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			BXFile bxfile = data.get(position);
			img.setTag(position);
